/********************************************************************************
** Form generated from reading UI file 'report-menu.ui'
**
...
#ifndef UI_REPORT_2D_MENU_H
#define UI_REPORT_2D_MENU_H
...
public:
    ...
    void setupUi(QDialog *ReportMenu)
    {
        ...
        ReportMenu->setStyleSheet(QString::fromUtf8(""));
